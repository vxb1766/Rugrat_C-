...
namespace edu.uta.cse.proggen.util
{
    ...
    public class ProgGenUtil
    {
        ...
        {
            HashSet<Type.Primitives> primitiveSet = null;
            List<Type.Primitives> primitiveSet1 = new List<Type.Primitives>();
            ...
            foreach (Variable @var in parameterList)
            {
                ...
                if (!(primitive == Type.Primitives.OBJECT))
                {
                    ...
                    primitiveSet1.Add(primitive);
                }
                count++;
                
            }
            primitiveSet = new HashSet<Type.Primitives>(primitiveSet1);
            return primitiveSet;
        }
