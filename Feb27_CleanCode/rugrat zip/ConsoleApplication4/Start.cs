...
namespace edu.uta.cse.proggen.start.Start
{
    ...
    public class Start
    {
        ...
        private static void write(string filename, string contents)
        {
            ...
            try
            {
                //                fos = new System.IO.FileStream(pathToDir + "TestPrograms" + Path.PathSeparator + "com" + Path.PathSeparator + "accenture" + Path.PathSeparator + "lab" + Path.PathSeparator + "carfast" + Path.PathSeparator + "test" + Path.PathSeparator + filename + ".cs", System.IO.FileMode.Create, System.IO.FileAccess.Write);
